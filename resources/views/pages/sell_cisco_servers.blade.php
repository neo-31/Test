@extends('layouts.app')
@section('title', 'Sell Cisco Sever Equipment')
@section('meta_description', 'Sell Used Cisco Server Equipment with VDR Resale at the best market price. We will buy all your used Cisco Hardware. Get a Quote Online. ')
        ...
        <ul>
            <li data-transition="random-static" >
                <video class="col-side-imgges" autoplay loop muted id="myVideo" width="100%" playsinline>
                    <source src="{{ asset('public/assets/images/slides/ciscobanner2.mp4') }}">
                </video>
                <div class="tp-caption sfl title-slide center" data-x="40" data-y="150" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">
                  <h1 class="col-h1"> Sell Cisco<br> Servers</h1>
                </div>
            </li>
        </ul>
    </div>
...
<!--            <li data-transition="random-static" >-->
<!--                <video class="col-side-imgges" autoplay loop muted id="myVideo" width="100%" playsinline>-->
<!--                    <source src="{{ asset('public/assets/images/slides/cisco-mob2.mp4') }}">-->
<!--                </video>-->
<!--                <div class="tp-caption sfl title-slide center" data-x="40" data-y="150" data-speed="1000" data-start="1000" data-easing="Power3.easeInOut">-->
<!--                Sell Cisco<br> Servers-->
<!--                </div>-->
<!--            </li>-->
<!--        </ul>-->
<!--    </div>-->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card"><br>
                    <div class="text-center" >
                        ...
                        <h3 class="col-h3">Best Prices Paid for Your Redundant Technology</h3>
                        ...
                        <h3 class="col-h3">New and Refurbished Equipment</h3>
            ...
            <div class="col-md-6">
                <div class="promobox style1 style2 clearfix">
                    <h2 class="promobox-title">We buy redundant Cisco server equipment</h2>
                    <p class="promobox-title col-p">Sell Cisco Servers, Cisco Access Points & any other <a class="col-a-color" href="https://www.vdrresale.com/service/sell-cisco-equipment"> equipment</a> your company no longer need. We are a family-owned Technology Lifecycle Management company. With over 40+ years of experience, we have never had one data breach. Now that’s experience you can trust! We understand that retiring your old IT equipment while trying to stay compliant and eco-friendly can be quite the balancing act. Our <a class="col-a-color"href="https://www.vdrresale.com/about">Technology Life Cycle Management Services </a>make the experience of selling your Cisco server equipment simple and easy.</p>
                </div>
            </div><!-- /.col-md-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
                ...
                <div class="sidebar-wrap">
                    <div class="sidebar">
                        ...
                        <div class="widget widget_recent_entries">
                            <h4 class="widget-title">By casting a wider net and utilising our long-term partners, we can offer you the best price for your redundant Cisco equipment.</h4>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul>
                                        <li style="display: inline-flex;">
                                            <i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i>Free Quote
                                        </li><br>
                                        <li style="display: inline-flex;">
                                    ...
                                    <div class="col-md-6">
                                        <ul>
                                        <li style="display: inline-flex;">
                                            <i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i>Fastest Payments
                                        </li>
                                        <li style="display: inline-flex;">
                                            <i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i>Recycle technology
                                        </li>
                                        <li style="display: inline-flex;">
                                            <i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i>Maximise your returns
                                        </li>
                                    </ul>
                                    </div>
                                    <div class="col-md-12">
                                        <p>We are one of the<a style="color:#E0C463;display: contents;" href="https://www.vdrresale.com/about"> UK's leading purchasers </a>of redundant IT equipment. We buy equipment wholesale from any manufacturer or brand. </p>
                                    ...
                                    <div class="text-center">
                                        <img class="col-images" src="{{asset('public/assets/images/slides/vdr_box1.jpeg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="sidebar-wrap">
                    <div class="sidebar">
                        ...
                        <div class="widget widget_recent_entries">
                            <div class="col-md-12">
                                <h2> How to Sell Your Cisco Server Equipment</h2>
                                <p>Recycle your Cisco Servers and equipment. As many as 56% of businesses do not use a professional service to recycle old technology equipment. You can maximise your value back on redundant technology equipment by contacting VDR Resale. Our large network of partners will offer you the best price. </p>
                            </div>
                        </div>
                    </div><!-- /.sidebar -->
                </div><!-- /.sidebar-wrap -->
...
<div class="flat-row flat-general sidebar-right">
    <div class="container">
        <div class="row">
            <h2 class=text-center>The Safest Place to <span class="scheme">Sell your Cisco Equipment</span></h2>
            ...
            <div class="col-md-8">
                <div class="sidebar-wrap">
                    <div class="sidebar">
                        ...
                        <div class="widget widget_recent_entries">
                            <div class="col-md-12">
                                <p>VDR Resale are the safest place to Sell Cisco Servers & Equipment online. We have never had a data breach and have been specifically trading new and used Cisco equipment for more than 40+ years. </p>
                                <h3>Sell Your Cisco Equipment Online</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="p-margin"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Cisco Servers</b></p>
                                        <p class="p-margin"><a href="https://vdr.rsjinfotech.com/sell-cisco-access-point"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Sell Cisco Access Points</b></a></p>
                                        <p class="p-margin"><a href="https://www.vdrresale.com/service/sell-cisco-equipment"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Sell Cisco Phones</b></a></p>
                                    </div>
                                    <div class="col-md-6">
                                        <p class="p-margin"><a href="https://www.vdrresale.com/service/sell-it-equipment"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Sell Cisco Networking Equipment</b></a></p>
                                        <p class="p-margin"><a href="https://www.vdrresale.com/service/sell-cisco-switches"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Sell Cisco Switches</b></a></p>
                                        <p class="p-margin"><a href="https://www.vdrresale.com/service/sell-it-equipment"><i class="fa fa-check my-3" style="margin: auto;margin-right: 5px;color: #30b530;"></i><b>Sell all redundant equipment</b></a></p>
                                    </div>
                                </div><br>
                            </div>
                        </div>
...
<div class="flat-row pad-top20px pad-bottom40px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="flat-title-section style w90 mag-bottom0px h2-margin-top">We Buy Equipment <span class="scheme">From All Manufacturers!</span></h2>
            </div><!-- /.col-md-12 -->
        </div><!-- /.row -->
            ...
            <div class="col-md-6">
                <div class="sidebar-wrap">
                    <div class="sidebar">
                        ...
                        <div class="widget widget_recent_entries">
                            <div class="col-md-12">
                                <h2>We securely wipe all data & destroy hard drives</h2>
                                <p>As many as 56% of businesses in the UK do not use a professional service to destroy old hard drives, USBs, and storage devices that contain their confidential information. This can lead to a major security risk. We provide secure, on-site hard drive destruction services, nationwide across the UK. We provide data destruction certificates for every wipe. Giving your company peace of mind. Avoid large fines and ensure your data is secure by using VDR Resales secure hard drive destruction services.</p>
                            </div>
                        </div>
                    </div><!-- /.sidebar -->
                </div><!-- /.sidebar-wrap -->
...
<div class="blog-shortcode">
    <div class="container">
        <div class="row">
             <div class="col-md-12"> 
                <h2 class="text-center h2-margin-top"> Why Choose <span class="scheme">VDR Resale</span></h2>
            </div>    
                        ...
                        <div class="content-inner clearfix">
                            ...
                            <div class="col-md-2 col-width">
                                <div class="entry-wrapper">
                                    <div class="entry-header">                                                
                                        <div class="entry-header-content col-font text-center">
                                            <i class="fa fa-tags icon-size"></i>
                                        </div><!-- /.entry-header-content -->
                                    </div><!-- /.entry-header -->
                            ...
                            <div class="col-md-2 col-width">
                                <div class="entry-wrapper">
                                    <div class="entry-header">                                                
                                        <div class="entry-header-content col-font text-center">
                                            <i class="fa fa-clock-o icon-size"></i>
                                        </div><!-- /.entry-header-content -->
                                    </div><!-- /.entry-header -->
                            ...
                            <div class="col-md-2 col-width">
                                <div class="entry-wrapper">
                                    <div class="entry-header">                                                
                                        <div class="entry-header-content col-font text-center">
                                            <i class="fa fa-industry icon-size"></i>
                                        </div><!-- /.entry-header-content -->
                                    </div><!-- /.entry-header -->
                            ...
                            <div class="col-md-2 col-width">
                                <div class="entry-wrapper">
                                    <div class="entry-header">                                                
                                        <div class="entry-header-content col-font text-center">
                                            <i class="fa fa-leaf icon-size"></i>
                                        </div><!-- /.entry-header-content -->
                                    </div><!-- /.entry-header -->
...
<div class="flat-row pad-bottom40px">
    <div class="container">
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-8">
                <h2 class="text-center h2-margin-top">Get in <span style="color: #E0C463">Touch</span> </h2>
