...
<div class="block-header">
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12 text-lg-right">
           {{-- <a href="{{URL::to('admin/videos/addvideos')}}" class="btn btn-primary theme-bg gradient btn-round"><i class="fa fa-plus"></i> Add Videos</a> --}}
        </div>
    </div>
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-hover js-basic-example dataTable table-custom spacing5">
                        ...
                        <tbody>
                          @foreach($allvideos_trash as $i => $video)
                            <tr>
                                <td>{{ $video->id }}</td>
                                <td>{{ $video->video_title }}</td>
                                <td>
                                    <a href="{{ url('admin/videos/trash/restore/'.$video->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit" title="Edit"></i> Restore</a>&nbsp;
                                    <a href="{{ url('admin/videos/trash/delete/'.$video->id) }}" class="btn btn-outline-danger btn-sm property_delete"><i class="fa fa-trash"></i> Delete</a>&nbsp;
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
