                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/service/status/'.$service->id) }}" class="btn btn-outline-success btn-sm">Active</a>
                                    @else
                                    <a href="{{ url('admin/service/status/'.$service->id) }}" class="btn btn-outline-danger btn-sm ">Deactive</a>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ url('admin/service/addservice/'.$service->id) }}" class="btn btn-outline-secondary btn-sm"><i class="fa fa-edit" title="Edit"></i> Edit</a>&nbsp;
                                    <a href="{{ url('admin/service/delete/'.$service->id) }}" class="btn btn-outline-danger btn-sm property_delete"><i class="fa fa-trash"></i> Delete</a>&nbsp;
                                </td>
                            </tr>
                            @endforeach
