            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-hover js-basic-example dataTable table-custom spacing5">
                        ...
                        <tbody>
                            @foreach ($allproduct_trash as $product)
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <a href="{{ url('admin/product/trash/restore/'.$product->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit" title="Edit"></i> Restore</a>&nbsp;
                                    <a href="{{ url('admin/product/trash/delete/'.$product->id) }}" class="btn btn-outline-danger btn-sm property_delete"><i class="fa fa-trash"></i> Delete</a>&nbsp;
                                </td>
                            </tr>
                            @endforeach
