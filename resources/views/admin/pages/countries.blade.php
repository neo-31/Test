...
<div class="block-header">
    <div class="row clearfix">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12 text-lg-right">
           <a href="{{URL::to('admin/countries/addcountries')}}" class="btn btn-primary theme-bg gradient btn-round"><i class="fa fa-plus"></i> Add Country</a>
        </div>
    </div>
                    ...
                    <table class="table table-hover js-basic-example dataTable table-custom spacing5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/countries/addcountries/'.$country->id) }}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit" title="Edit"></i> Edit</a>&nbsp;
                                    <a href="{{ url('admin/countries/delete/'.$country->id) }}" class="btn btn-outline-danger btn-sm property_delete"><i class="fa fa-trash"></i> Delete</a>&nbsp;
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
