   	...
   	<div class="panel panel-default">
            <div class="panel-body">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select name="user_type" id="basic" class="selectpicker show-tick form-control" data-live-search="true">
								@if(isset($user->user_type))

								<option value="Owner" @if($user->user_type=='Owner') selected @endif>Owner</option>
								<option value="Agents" @if($user->user_type=='Agents') selected @endif>Agents</option>
								<option value="Builder" @if($user->user_type=='Builder') selected @endif>Builder</option>
