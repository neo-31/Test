...
@section('title', 'Trash Lead Application')
            ...
            <div class="body">
                <div class="table-responsive">
                    <table class="table table-hover js-basic-example dataTable table-custom spacing5">
                        ...
                        <tbody>
                          @foreach($Lead as $i => $lead)
                            <tr>
                                <td>{{ $lead->id }}</td>
                                <td>{{ $lead->contact_name }}</td>
                                <td>
                                    <a href="{{url('admin/restore-lead',$lead->id)}}" class="btn btn-outline-warning btn-sm"><i class="fa fa-edit" title="Edit"></i> Restore</a>&nbsp;
                                    <a href="{{url('admin/hard-delete-lead',$lead->id)}}" class="btn btn-outline-danger btn-sm property_delete"><i class="fa fa-trash"></i> Delete</a>&nbsp;
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
